...
const ListAlamat = () => {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`${apiUrl}/alamat/${id}`, {
        headers: {
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-center gap-1.5">
                            {/* Edit */}
                            <button
                              onClick={() => navigate(`/alamat/edit/${a.id}`)}
                              title="Edit"
      ...
      {confirmDelete && (
        ...
        >
          ...
          >
            ...
            >
              Tindakan ini tidak dapat dibatalkan. Data alamat akan dihapus
              secara permanen.
            </p>
