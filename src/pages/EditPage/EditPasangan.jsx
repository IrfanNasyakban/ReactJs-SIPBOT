...
const EditPasangan = () => {
  ...
  const getPasanganById = async () => {
    const token = localStorage.getItem("accessToken");
    const response = await axios.get(`http://localhost:5000/pasangan/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
    setNamaPasangan(response.data.namaPasangan);
    setNamaDenganGelar(response.data.pegawai.namaDenganGelar);
    setNip(response.data.pegawai.nip);
  };

  const updatePasangan = async (e) => {
    e.preventDefault();
    ...
    try {
      const token = localStorage.getItem("accessToken");
      await axios.patch(`http://localhost:5000/pasangan/${id}`, jsonData, {
        headers: {
          Authorization: `Bearer ${token}`,
      ...
      <div className="relative z-10 p-7">
        ...
        <div className="flex items-start justify-between flex-wrap gap-4 mb-8">
          <div className="flex-1">
            ...
            >
              Formulir Perubahan Data Pasangan Pegawai - Kantor Imigrasi Kelas
              II TPI Lhokseumawe
            </p>
          </div>
        </div>
        ...
        <form onSubmit={updatePasangan}>
          ...
          >
            ...
            <div className="p-8">
              ...
              {/* ── Section 1: Data Pasangan (Suami/Istri) ── */}
              <div className="mb-8">
                <div
                  className="pb-4 border-b"
                  style={{
                ...
                <div className="gap-6 mt-6">
                  ...
                  <div>
                    ...
                    >
                      Nama Pasangan <span style={{ color: "#ef4444" }}>*</span>
                    </label>
                    <input
                      name="namaPasangan"
                      type="text"
