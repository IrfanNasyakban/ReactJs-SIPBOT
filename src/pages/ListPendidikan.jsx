...
const ListPendidikan = () => {
  ...
  const filtered = pendidikan.filter((p) =>
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`${apiUrl}/pendidikan/${id}`, {
        headers: {
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = "data_pendidikan.csv";
    a.click();
        ...
        >
          ...
          {!isLoading && (
            <div className="overflow-x-auto">
              <table
                className="w-full"
                style={{ minWidth: 1000, borderCollapse: "collapse" }}
              >
                <thead>
                  <tr
                    style={{
                  ...
                  >
                    {["No", "Nama", "Pendidikan Terakhir", "Aksi"].map((h) => (
                      <th
                        key={h}
      ...
      {confirmDelete && (
        ...
        >
          ...
          >
            ...
            >
              Tindakan ini tidak dapat dibatalkan. Data pendidikan akan dihapus
              secara permanen.
            </p>
