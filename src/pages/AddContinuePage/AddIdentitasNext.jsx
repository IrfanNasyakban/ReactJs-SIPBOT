...
const STEPS = [
  ...
  { id: 5,  label: "Data Identitas",   status: "current" },
...
const AddIdentitasNext = () => {
  ...
  const saveIdentitas = async (e) => {
    e.preventDefault();
    setLoading(true);
    const jsonData = { idPegawai, nik, nomorKK, nomorBPJS, nomorTaspen };
    try {
      const token = localStorage.getItem("accessToken");
      ...
      setLoading(false);
      navigate("/next/add/rekening", { state: { idPegawai, namaPegawai } });
    } catch (error) {
      setLoading(false);
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className={`text-2xl font-bold tracking-wide ${isDark ? "text-white" : "text-gray-900"}`}>
                Tambah Data <span style={{ color: currentColor }}>Identitas</span>
              </h1>
            </div>
            <p className="text-xs ml-11 mt-1" style={{ color: isDark ? "rgba(255,255,255,.35)" : "rgba(0,0,0,.5)" }}>
              Formulir Penambahan Data Identitas Baru - Kantor Imigrasi Kelas II TPI Lhokseumawe
            </p>
          </div>
        </div>
            ...
            <div className="p-8">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-6 mt-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-2" style={labelStyle}>
                      Nomor KK (Kartu Keluarga) <span style={{ color: "#ef4444" }}>*</span>
                    </label>
                    <input
                      name="nomorKK" type="text" required
                      placeholder="16 digit angka"
                      maxLength={16}
                      className="w-full px-4 py-2.5 rounded-xl text-sm transition-all duration-200"
                      style={inputBase} value={nomorKK}
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-6 mt-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-2" style={labelStyle}>
                      Nomor BPJS Kesehatan <span style={{ color: "#ef4444" }}>*</span>
                    </label>
                    <input
                      name="nomorBPJS" type="text" required
                      placeholder="13 digit angka"
                      maxLength={13}
                      className="w-full px-4 py-2.5 rounded-xl text-sm transition-all duration-200"
                      style={inputBase} value={nomorBPJS}
                      onChange={(e) => setNomorBPJS(e.target.value.replace(/\D/g, ""))}
                      onFocus={onFocus} onBlur={onBlur}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      name="nomorTASPEN" type="text" required
                      placeholder="Nomor TASPEN"
                      className="w-full px-4 py-2.5 rounded-xl text-sm transition-all duration-200"
                      style={inputBase} value={nomorTaspen}
...
export default AddIdentitasNext;