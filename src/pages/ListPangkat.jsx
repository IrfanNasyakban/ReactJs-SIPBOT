...
const ListPangkat = () => {
  ...
  const getPangkat = async () => {
    try {
      ...
      const response = await axios.get(`${apiUrl}/pangkat`, {
  ...
  const filtered = pangkat.filter((k) =>
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`${apiUrl}/pangkat/${id}`, {
        headers: {
      ...
      console.error("Error deleting pangkat:", err);
                  ...
                  {paginated.length === 0 ? (
                    ...
                    paginated.map((p, i) => (
                      ...
                      >
                        ...
                        >
                          {new Date(p.tanggalSKPangkat).toLocaleDateString(
                            "id-ID",
                          )}
                        </td>
                        {/* Nomor SK Pangkat */}
                        ...
                        >
                          {new Date(p.tmtPangkat).toLocaleDateString("id-ID")}
                        </td>
                        {/* Aksi */}
                        <td className="px-4 py-3">
      ...
      {confirmDelete && (
        ...
        >
          ...
          >
            ...
            >
              Tindakan ini tidak dapat dibatalkan. Data pangkat akan dihapus
              secara permanen.
            </p>
