...
const ListKepegawaian = () => {
  ...
  const filtered = kepegawaian.filter((k) =>
    k.pegawai?.namaDenganGelar?.toLowerCase().includes(search.toLowerCase()),
  );
  ...
  const statusBadge = (status) => {
    const mapDark = {
      ...
      CPNS: "bg-amber-500/10 text-amber-400 border-amber-500/30",
      Outsourcing: "bg-purple-500/10 text-purple-400 border-purple-500/30",
    };
    const mapLight = {
      PNS: "bg-emerald-500/15 text-emerald-600 border-emerald-500/40",
      PPPK: "bg-blue-500/15 text-blue-600 border-blue-500/40",
      CPNS: "bg-amber-500/15 text-amber-600 border-amber-500/40",
      Outsourcing: "bg-purple-500/15 text-purple-600 border-purple-500/40",
    };
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`${apiUrl}/kepegawaian/${id}`, {
        headers: {
      ...
      <div className="relative z-10 p-7">
        ...
        <div className="flex items-start justify-between flex-wrap gap-4 mb-6">
          <div>
            ...
            >
              Data <span style={{ color: currentColor }}>Kepegawaian</span>
            </h1>
            <p
            ...
            >
              Manajemen data kepegawaian dan informasi jabatan pegawai
            </p>
          </div>
        ...
        >
          ...
          {!isLoading && (
            <div className="overflow-x-auto">
              <table
                className="w-full"
                style={{ minWidth: 1400, borderCollapse: "collapse" }}
              >
                <thead>
                  <tr
                    style={{
                  ...
                  {paginated.length === 0 ? (
                    ...
                    paginated.map((k, i) => (
                      ...
                      >
                        ...
                        {/* Status */}
                        <td className="px-4 py-3">
                          {statusBadge(k.statusKepegawaian)}
                        </td>
                        {/* Jabatan */}
                        <td
                          className="px-4 py-3 text-sm"
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-center gap-1.5">
                            ...
                            <button
                              onClick={() =>
                                navigate(`/kepegawaian/edit/${k.id}`)
                              }
                              title="Edit"
      ...
      {confirmDelete && (
        ...
        >
          ...
          >
            ...
            >
              Tindakan ini tidak dapat dibatalkan. Data kepegawaian akan dihapus
              secara permanen.
            </p>
...
export default ListKepegawaian;
