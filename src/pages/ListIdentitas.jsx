...
const ListIdentitas = () => {
  ...
  const getIdentitas = async () => {
    try {
      ...
      const response = await axios.get(`${apiUrl}/identitas`, {
  ...
  const filtered = identitas.filter((id) =>
    id.pegawai?.namaDenganGelar?.toLowerCase().includes(search.toLowerCase()),
  );
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`${apiUrl}/identitas/${id}`, {
        headers: {
      ...
      console.error("Error deleting identitas:", err);
        ...
        >
          ...
          {!isLoading && (
            <div className="overflow-x-auto">
              <table
                className="w-full"
                style={{ minWidth: 1300, borderCollapse: "collapse" }}
              >
                <thead>
                  <tr
                    style={{
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-center gap-1.5">
                            ...
                            {/* Delete */}
                            <button
                              onClick={() => setConfirmDelete(id.id)}
                              title="Hapus"
                              className="w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-150 hover:-translate-y-0.5"
                              style={{
                                background: "transparent",
      ...
      {confirmDelete && (
        ...
        >
          ...
          >
            ...
            >
              Tindakan ini tidak dapat dibatalkan. Data identitas akan dihapus
              secara permanen.
            </p>
