...
const STEPS = [
  ...
  { id: 8,  label: "Data Fisik",       status: "current" },
...
const AddFisikNext = () => {
  ...
  const saveFisik = async (e) => {
    ...
    try {
      const token = localStorage.getItem("accessToken");
      const response = await axios.post("http://localhost:5000/fisik", jsonData, {
        headers: {
        ...
        <div className="flex items-start justify-between flex-wrap gap-4 mb-6">
          <div className="flex-1">
            ...
            <p className="text-xs ml-11 mt-1" style={{ color: isDark ? "rgba(255,255,255,.35)" : "rgba(0,0,0,.5)" }}>
              Formulir Penambahan Data Ciri-Ciri Fisik Pegawai - Kantor Imigrasi Kelas II TPI Lhokseumawe
            </p>
          </div>
        </div>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-6 mt-6">
                  ...
                  <div>
                    ...
                    <input
                      name="beratBadan" type="number" required
                      placeholder="Contoh: 65"
                      className="w-full px-4 py-2.5 rounded-xl text-sm transition-all duration-200"
                      style={inputBase} value={beratBadan}
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-6 mt-6">
                  <div>
                    ...
                    <select
                      name="jenisRambut" required
                      className="w-full px-4 py-2.5 rounded-xl text-sm transition-all duration-200"
                      style={selectBase} value={jenisRambut}
                      onChange={(e) => setJenisRambut(e.target.value)}
                      onFocus={onFocus} onBlur={onBlur}
                    >
                      <option value="">-- Pilih Jenis Rambut --</option>
                      <option value="lurus"        style={{ color: "black" }}>Lurus</option>
                      <option value="bergelombang" style={{ color: "black" }}>Bergelombang</option>
                      <option value="keriting"     style={{ color: "black" }}>Keriting</option>
                      <option value="ikal"         style={{ color: "black" }}>Ikal</option>
                    </select>
                  </div>
                  <div>
                    <label className="block text-sm font-semibold mb-2" style={labelStyle}>
                    ...
                    <select
                      name="warnaRambut" required
                      className="w-full px-4 py-2.5 rounded-xl text-sm transition-all duration-200"
                      style={selectBase} value={warnaRambut}
                      onChange={(e) => setWarnaRambut(e.target.value)}
                      onFocus={onFocus} onBlur={onBlur}
                    >
                      <option value="">-- Pilih Warna Rambut --</option>
                      <option value="hitam"  style={{ color: "black" }}>Hitam</option>
                      <option value="coklat" style={{ color: "black" }}>Coklat</option>
                      <option value="pirang" style={{ color: "black" }}>Pirang</option>
                      <option value="merah"  style={{ color: "black" }}>Merah</option>
                      <option value="uban"   style={{ color: "black" }}>Uban</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-6 mt-6">
                  <div>
                    ...
                    <select
                      name="bentukWajah" required
                      className="w-full px-4 py-2.5 rounded-xl text-sm transition-all duration-200"
                      style={selectBase} value={bentukWajah}
                      onChange={(e) => setBentukWajah(e.target.value)}
                      onFocus={onFocus} onBlur={onBlur}
                    >
                      <option value="">-- Pilih Bentuk Wajah --</option>
                      <option value="bulat"   style={{ color: "black" }}>Bulat</option>
                      <option value="lonjong" style={{ color: "black" }}>Lonjong</option>
                      <option value="persegi" style={{ color: "black" }}>Persegi</option>
                      <option value="hati"    style={{ color: "black" }}>Hati</option>
                      <option value="berlian" style={{ color: "black" }}>Berlian</option>
                    </select>
                  </div>
                  <div>
                    <label className="block text-sm font-semibold mb-2" style={labelStyle}>
                    ...
                    <select
                      name="warnaKulit" required
                      className="w-full px-4 py-2.5 rounded-xl text-sm transition-all duration-200"
                      style={selectBase} value={warnaKulit}
                      onChange={(e) => setWarnaKulit(e.target.value)}
                      onFocus={onFocus} onBlur={onBlur}
                    >
                      <option value="">-- Pilih Warna Kulit --</option>
                      <option value="putih"         style={{ color: "black" }}>Putih</option>
                      <option value="kuning langsat" style={{ color: "black" }}>Kuning Langsat</option>
                      <option value="sawo matang"   style={{ color: "black" }}>Sawo Matang</option>
                      <option value="coklat"        style={{ color: "black" }}>Coklat</option>
                      <option value="hitam"         style={{ color: "black" }}>Hitam</option>
                    </select>
                  </div>
